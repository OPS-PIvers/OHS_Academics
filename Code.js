...
function doGet(e) {
  ...
  // Route: System Health Diagnostic (Admin Only)
  if (e && e.parameter && e.parameter.page === 'tests') {
    if (userInfo && userInfo.role === 'ADMIN') {
      ...
      return HtmlService.createHtmlOutput("<h1>Access Denied</h1><p>Diagnostic tools are restricted to Administrators.</p>");
    }
  }
