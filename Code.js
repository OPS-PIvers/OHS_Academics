...
function doGet(e) {
  ...
  // Check for specialized pages (like System Health Diagnostic)
  // Only ADMINs should access these tools
  if (e && e.parameter && e.parameter.page === 'tests' && userInfo && userInfo.role === 'ADMIN') {
