...
function doGet(e) {
  ...
  // Route to System Health Diagnostic page if requested and user is ADMIN
  if (e && e.parameter && e.parameter.page === 'tests') {
    if (userInfo && userInfo.role === 'ADMIN') {
      ...
      return HtmlService.createHtmlOutput("Access Denied: Admin privileges required for diagnostic tools.")
